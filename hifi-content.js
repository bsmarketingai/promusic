...
(function () {
  ...
  const megaPanel = (m) => `
    <div class="megapanel">
      ...
      <a class="megafeat" href="${m.feat.href}">
        ...
        <div class="megafeat-meta"><ui-tag>${m.feat.tag}</ui-tag><strong>${m.feat.title}</strong><span class="megafeat-go">Zobrazit →</span></div>
      </a>
    </div>`;
  ...
  <!-- STATS -->
  <section class="sec-tight reveal stage-glow" id="statsGlow"><div class="wrap"><div class="stats" data-stagger>
    <div class="stat"><div class="n">28&nbsp;<span class="u">let</span></div><div class="l">zkušeností od 1997</div></div>
    <div class="stat"><div class="n">17</div><div class="l">zemí Evropy · Rammstein</div></div>
    <div class="stat"><div class="n">20<span class="u">+</span></div><div class="l">světových značek</div></div>
    <div class="stat"><div class="n">3<span class="u">×</span></div><div class="l">L-ISA instalace v ČR</div></div>
  </div></div></section>
  ...
  <section class="sec reveal"><div class="wrap">
    ...
    <div class="segments" data-stagger>
      ${segments.map(([t, d, href], i) => `<a class="segcard" href="${href || '#'}"><span class="sn">${String(i + 1).padStart(2, "0")}</span><strong>${t}</strong><span class="sd">${d}</span><span class="sg">Vstoupit →</span></a>`).join("")}
    </div>
  </div></section>
  ...
  <!-- EDU: Imerzivní zvuk (vysvětlující karusel) -->
  <section class="sec edu-sec reveal" id="eduImmersive"></section>
  ...
  <section class="sec reveal"><div class="wrap-wide">
    ...
    <div class="work" data-stagger>
      ...
      <a class="workcard col-6" href="instalace-hd-karlin.html"><img src="${P}karlin/zvukar-foh.jpg" alt="" /><span class="wlogo">DiGiCo</span><div class="ov"><ui-tag solid>Instalace / Zvuk</ui-tag><h3>Hudební divadlo Karlín</h3><span class="wmeta">DiGiCo Quantum 7T · muzikál</span></div></a>
  ...
  <section class="sec reveal"><div class="wrap-wide">
    ...
    <div class="reel" data-stagger>
      ${reel.map(([s, l]) => `<a class="clip" href="#"><img src="${s}" alt="" /><span class="play">▶</span><span class="clip-l">${l}</span></a>`).join("")}
    </div>
  </div></section>
  ...
  <section class="sec band wave-band reveal"><div class="wrap-wide">
    ...
    <div class="refcounts" data-stagger>
      <div class="stat"><div class="n">40<span class="u">+</span></div><div class="l">divadel & scén</div></div>
      <div class="stat"><div class="n">25</div><div class="l">arén & hal</div></div>
      <div class="stat"><div class="n">∞</div><div class="l">festivalů & turné</div></div>
      <div class="stat"><div class="n">3<span class="u">×</span></div><div class="l">L-ISA v ČR</div></div>
    </div>
